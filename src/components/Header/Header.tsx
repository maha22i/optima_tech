    ...
    <>
      <motion.header
        ...
        style={{
          ...
          borderBottom: isScrolled ? `1px solid ${colors.dominant.border}20` : 'none'
        }}
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      ...
      >
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
          ...
          <div className="flex items-center h-14 sm:h-16 lg:h-18">
            {/* Logo */}
            <Link href="/" className="flex items-center group pl-4 sm:pl-6 lg:pl-8" onClick={closeMenu}>
              <motion.div 
                className="relative"
            ...
            <nav className="hidden lg:flex justify-center items-center space-x-1 mx-auto">
            ...
            <div className="hidden lg:flex items-center ml-4">
              ...
              >
                <Link
                  href="/contact"
                  className="inline-flex items-center px-6 py-3 font-semibold rounded-xl transition-all duration-200 hover:scale-105 shadow-md hover:shadow-lg cursor-pointer ml-4"
                  style={{ 
            ...
            <motion.button
              ...
              style={{ 
                backgroundColor: isMenuOpen ? colors.accent.primary : `${colors.dominant.border}30`,
          ...
          <>
            ...
            >
              <div className="flex flex-col h-full">
                {/* Mobile Header */}
                <div className="flex items-center justify-between p-4 sm:p-6 border-b" style={{ borderColor: colors.dominant.border }}>
                  <div className="flex items-center space-x-3">
                    <Image src="/logo-removebg.png" alt="Logo" width={40} height={40} className="w-8 h-8 sm:w-10 sm:h-10" priority />
                  </div>
                  <button
                    onClick={closeMenu}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <a
                          ...
                          style={{ backgroundColor: `${colors.support.primary}08` }}
                        >
                          <div 
                            className="w-10 h-10 rounded-lg flex items-center justify-center"
                            style={{ backgroundColor: colors.support.primary }}
                          >
                            <Mail size={16} style={{ color: colors.text.inverse }} />
                          </div>
                          <div>
